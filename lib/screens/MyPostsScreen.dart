...
// CreatePostScreen (you can add your previous implementation of the form here)
...
// MyPostsScreen with floating action button
class MyPostsScreen extends StatelessWidget {
  // Method to handle new post creation (navigate to another screen)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        tooltip: 'Add New Post', // Tooltip text when user long-presses
      ),
    );
  }
}
